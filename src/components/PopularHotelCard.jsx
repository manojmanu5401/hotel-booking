  ...
  return (
    <>
      <div className="w-full mx-auto max-w-sm bg-white rounded-lg shadow-lg">
        ...
        <a href="/"><img className="rounded-t-lg transition-transform ease-in-out delay-100 hover:scale-150" src={imagePath} alt="" loading="lazy"/></a>
        </div>
          ...
          <div className="flex items-center mt-2.5 mb-5">
            <div className="stars">
            {
                [...Array(rating)].map((u,i)=>{
                    return <span key={u} className="material-symbols-outlined w-5 h-5 text-yellow-300 mr-1">star</span>
                })
            }
            </div>
